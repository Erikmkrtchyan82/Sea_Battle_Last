...
abstract class window extends JPanel {
    ...
    public synchronized void missedSound(){
        try{
            AudioInputStream audioIn= AudioSystem.getAudioInputStream(window.class.getResource("/battle/sounds/missed.wav"));
    ...
    public synchronized void hittedSound(){
        try{
            AudioInputStream audioIn= AudioSystem.getAudioInputStream(window.class.getResource("/battle/sounds/hitted.wav"));
            AudioFormat format=audioIn.getFormat();
            DataLine.Info info=new DataLine.Info(Clip.class,format);
            Clip clip=(Clip)AudioSystem.getLine(info);
            clip.open(audioIn);
    ...
    public synchronized void destroyedSound(){
        try{
            AudioInputStream audioIn= AudioSystem.getAudioInputStream(window.class.getResource("/battle/sounds/destroyed.wav"));
            AudioFormat format=audioIn.getFormat();
            DataLine.Info info=new DataLine.Info(Clip.class,format);
            Clip clip=(Clip)AudioSystem.getLine(info);
            clip.open(audioIn);
    ...
    public static synchronized void openSound(){
        try{
            AudioInputStream audioIn= AudioSystem.getAudioInputStream(window.class.getResource("/battle/sounds/open.wav"));
            AudioFormat format=audioIn.getFormat();
            DataLine.Info info=new DataLine.Info(Clip.class,format);
            Clip clip=(Clip)AudioSystem.getLine(info);
            clip.open(audioIn);
    ...
    protected synchronized void loadImg() {
        ImageIcon iSea = new ImageIcon( getClass().getResource("/battle/pictures/board/blue.png"));
        ImageIcon iHit = new ImageIcon(getClass().getResource("/battle/pictures/board/boat_red.png"));
        ImageIcon iDestroy = new ImageIcon(getClass().getResource("/battle/pictures/board/boat_black.png"));
        ImageIcon iBoat = new ImageIcon(getClass().getResource("/battle/pictures/board/boat_white.png"));
        ImageIcon iEmpty = new ImageIcon(getClass().getResource("/battle/pictures/board/x.png"));
        ImageIcon iEmpty_n = new ImageIcon(getClass().getResource("/battle/pictures/board/x_red.png"));
        ...
        for (int i = 0; i < 10; i++) {
            defNumber[i] = new ImageIcon(getClass().getResource("/battle/pictures/numbers/" + i + "-d.png")).getImage().getScaledInstance(tileLength, tileLength, Image.SCALE_SMOOTH);
            defLetter[i] = new ImageIcon(getClass().getResource("/battle/pictures/letters/" + i + "-dl.png")).getImage().getScaledInstance(tileLength, tileLength, Image.SCALE_SMOOTH);
            sNumber[i] = new ImageIcon(getClass().getResource("/battle/pictures/numbers/" + i + "-s.png")).getImage().getScaledInstance(tileLength, tileLength, Image.SCALE_SMOOTH);
            sLetter[i] = new ImageIcon(getClass().getResource("/battle/pictures/letters/" + i + "-sl.png")).getImage().getScaledInstance(tileLength, tileLength, Image.SCALE_SMOOTH);
        }
    }
    ...
    public synchronized void winner(String name){
        ...
        if(name.equalsIgnoreCase("you win")){
            ...
            icon=new ImageIcon(getClass().getResource("/battle/pictures/happy.png"));
        }else{
            title="it's a pity".toUpperCase();
            icon=new ImageIcon(getClass().getResource("/battle/pictures/sad.png"));
        }
